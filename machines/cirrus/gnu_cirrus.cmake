...
if (USE_KOKKOS)
  ...
  if (KOKKOS_GPU_OFFLOAD)
    ...
    string(APPEND CXXFLAGS " -extended-lambda -Wext-lambda-captures-this -std=c++17 -arch=sm_86 -L$CUDA_PATH/lib64 -lcudart -lcublas")
    string(APPEND LDFLAGS " -L$CUDA_PATH/lib64 -lcudart -lcublas ")
  else()
